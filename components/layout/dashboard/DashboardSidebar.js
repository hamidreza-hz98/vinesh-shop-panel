...
import { getDrawerSxTransitionMixin, getDrawerWidthTransitionMixin, matchPath } from '@/lib/mixins';
        ...
        >
          {sidebarRoutes.map((section, idx) => (
            <React.Fragment key={section.header}>
              <DashboardSidebarHeaderItem>{section.header}</DashboardSidebarHeaderItem>
              ...
              {idx < sidebarRoutes.length - 1 && <DashboardSidebarDividerItem />}
            </React.Fragment>
          ))}
        </List>
      </Box>
